...
export default function ContactForm() {
  ...
  const inputClass =
    'w-full rounded-xl border border-zinc-700/50 bg-zinc-950/60 backdrop-blur-sm focus:border-rose-500 focus:ring-2 focus:ring-rose-500/15 px-4 py-3 text-sm text-white placeholder:text-zinc-600 outline-none transition-all duration-200';

  return (
    <ScrollAnimate>
      {/*
        SECTION LAYOUT:
        - The section itself has bg-zinc-950 and no bottom padding.
        - The right-side image is absolutely positioned OUTSIDE the container,
          bleeding to the right viewport edge from ~42% of the section width.
        - All content (left info + right form) lives inside the container grid.
      */}
      <section className="relative w-full bg-zinc-950 text-white select-none pt-16 md:pt-20 overflow-hidden transition-colors duration-300">

        {/* ── Right-bleed Image (OUTSIDE container, absolutely positioned) ── */}
        <div className="hidden lg:block absolute inset-y-0 right-0 left-[42%] pointer-events-none">
          <img
        ...
        <div className="relative z-10 container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 relative flex flex-col gap-8">
              {/* Decorative rose blobs */}
              <div className="absolute -top-20 -left-20 w-72 h-72 bg-rose-600/12 rounded-full blur-3xl pointer-events-none" />
              <div className="absolute bottom-0 right-0 w-48 h-48 bg-rose-500/6 rounded-full blur-3xl pointer-events-none" />
            ...
            {/* ── Right Column: Form content only (image is the absolute bg behind) ── */}
            <div className="lg:col-span-7 py-4 lg:py-0 flex flex-col justify-center space-y-6">
