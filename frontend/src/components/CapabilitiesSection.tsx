...
export default function CapabilitiesSection() {
  ...
  return (
    <section className="w-full bg-zinc-950 text-white select-none border-b border-zinc-900 rounded-none">
      {/* Outer 2-column container - strictly rounded-none */}
      <div className="grid grid-cols-1 lg:grid-cols-12 w-full min-h-[600px] items-stretch rounded-none">
        
        {/* Left half: Context and Info data (6 cols) */}
        <div className="lg:col-span-6 bg-zinc-950 p-8 md:p-16 flex flex-col justify-between space-y-12 z-25 relative rounded-none">
          <div className="space-y-8">
            ...
            <div className="space-y-6 transition-all duration-500 min-h-[220px]">
              <div className="space-y-2">
              ...
              <p className="text-xs md:text-sm text-zinc-400 leading-relaxed font-semibold max-w-xl">
        ...
        {/* Right part: Swiper slider with Images (6 cols) - strictly rounded-none */}
        <div className="lg:col-span-6 relative h-[380px] lg:h-auto min-h-[380px] z-10 rounded-none overflow-hidden select-none">
