...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-[#4A2E80] overflow-hidden min-h-[650px] flex items-center">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full md:w-[52%] z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#4A2E80] via-[#4A2E80]/85 to-transparent z-10 hidden md:block" />
        {/* Mobile tint overlay */}
        <div className="absolute inset-0 bg-[#4A2E80]/85 md:hidden z-10" />
        <img
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-6 animate-fade-up">
            ...
            <p className="text-sm md:text-base text-purple-100 max-w-lg leading-relaxed">
        ...
        {/* Pink slide indicator at the bottom center of the purple banner */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex justify-center z-20">
          <div className="h-1.5 w-16 bg-[#D81B60] rounded-full" />
        </div>
