  ...
  const milestones = [
    {
      ...
      desc: "Medi-Doc Hospital was established in Addis Ababa as a specialized care clinic focusing on cardiology and pediatrics.",
    },
    {
      year: "2016",
      title: "Expansion & Lab Wing",
      desc: "Opened our advanced laboratory division and diagnostic imaging center to support tertiary care capabilities.",
    },
    {
      year: "2020",
      title: "Digital Transformation",
      desc: "Launched the integrated Patient Portal and e-prescription platform to connect patients and care teams online.",
    },
    {
      year: "2024",
      title: "Tertiary Care Center",
      desc: "Officially accredited as a premier Tertiary Care and Research Hospital, serving patients nationwide.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-base text-slate-600 dark:text-zinc-300 leading-relaxed max-w-xl">
                Medi-Doc Hospital is a premier multi-specialty tertiary care
                hospital dedicated to providing high-quality, patient-centered
                clinical services. We combine expert medical talent with
                state-of-the-art diagnostic facilities to deliver comprehensive
      ...
      <ScrollAnimate>
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="p-6 rounded-[10px] border border-slate-100 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/50 shadow-xs flex flex-col justify-between space-y-4"
            >
              <div className="p-3 w-fit rounded-lg bg-slate-50 dark:bg-zinc-800">
                {stat.icon}
              </div>
              <div>
                <div className="text-3xl font-bold text-slate-950 dark:text-white tracking-tight">
                  {stat.value}
                </div>
                <div className="text-sm text-slate-500 dark:text-zinc-400 font-medium mt-1">
                  {stat.label}
                </div>
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-base text-slate-600 dark:text-zinc-300 leading-relaxed">
              Medi-Doc Hospital was established in 2012 with a single, clear
              objective: to deliver world-class medical services right to the
              community. Over the years, our campus in Addis Ababa has grown
              into a leading center for critical patient care, diagnostics, and
            ...
            <div className="p-5 rounded-[10px] border border-emerald-500/10 bg-emerald-500/5 text-emerald-800 dark:text-emerald-300 space-y-3">
              ...
              <p className="text-sm text-emerald-700/90 dark:text-emerald-400/90 leading-relaxed">
                Every facility, prescription record, and diagnostic routine is
                held to high international medical standards.
              </p>
            </div>
          </div>
      ...
      <ScrollAnimate>
        <section className="space-y-8">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">
              Our Core Care Pillars
            </h2>
            <p className="text-sm text-slate-500 dark:text-zinc-400">
              A specialized approach that forms the bedrock of Medi-Doc
              Hospital's daily medical practices and operations.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((v) => (
              <div
                key={v.title}
                className={`p-6 rounded-[10px] border flex flex-col space-y-4 transition-all hover:-translate-y-1 ${v.bg}`}
              >
