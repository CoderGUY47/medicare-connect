            ...
            <div className="relative z-10">
              ...
              <div className="mt-14 space-y-4">
                ...
                <p className="text-zinc-300 text-xs leading-relaxed max-w-xs font-semibold">
                  Secure access to the Hospital Management System for healthcare
                  professionals
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 my-10 relative z-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-zinc-400 mt-0.5 font-medium">
                    Live patient data and notifications
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-zinc-400 mt-0.5 font-medium">
                    Customized access for each department
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-md mx-auto space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {ROLE_META.map((role) => {
                    ...
                    const roleCred = credentials.find(
                      (c: any) => c.role === role.id,
                    );
                    return (
                      <button
                        key={role.id}
                      ...
                      >
                        ...
                        <span
                          className={`text-[11px] font-semibold transition-colors ${
                            isSelected
                              ? "text-rose-650 dark:text-rose-300 font-bold"
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                ...
                {(() => {
                  ...
                  const roleLabel =
                    ROLE_META.find((r) => r.id === selectedRole)?.label ||
                    selectedRole;
                  if (!cred) return null;
                  return (
                    <div className="rounded-lg border border-emerald-500/25 bg-emerald-500/5 dark:bg-emerald-500/8 p-3 space-y-2">
                      ...
                      <div className="flex items-center justify-between gap-2 bg-white/60 dark:bg-zinc-900/50 rounded-md px-3 py-2 border border-slate-100 dark:border-zinc-800">
                        <div className="min-w-0">
                          <div className="text-[9px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-600">
                            Email
                          </div>
                          <div className="font-mono text-xs font-semibold text-slate-800 dark:text-zinc-100 truncate">
                            {cred.email}
                          </div>
                        </div>
                        <button
                      ...
                      <div className="flex items-center justify-between gap-2 bg-white/60 dark:bg-zinc-900/50 rounded-md px-3 py-2 border border-slate-100 dark:border-zinc-800">
                        <div className="min-w-0">
                          ...
                          <div className="font-mono text-xs font-semibold text-slate-800 dark:text-zinc-100">
                            {cred.pw}
                          </div>
                        </div>
                        <button
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  <Link
                    href="#"
                    className="text-[11px] text-rose-650 dark:text-rose-500  hover:text-rose-700 dark:hover:text-rose-305 font-bold transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
