...
export default function LabDashboardLayout({
  ...
  if (isLoading) {
    return <LoadingScreen message="Authenticating laboratory workspace..." />;
  }
        ...
        <div className="p-5 border-b border-slate-100 dark:border-zinc-800 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-450 dark:text-zinc-500 font-bold uppercase tracking-wider">Laboratory Station</p>
            </div>
          </Link>
          <button
            onClick={() => setIsMobileMenuOpen(false)}
