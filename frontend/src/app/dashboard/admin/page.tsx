...
export default function AdminOverviewPage() {
  ...
  const distributionData = [
    { name: 'OPD Patients', value: 267, color: '#e11d48' }, // Rose 600
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-slate-100 dark:border-zinc-900 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400 mt-0.5">Real-time clinical metrics & AI insights</p>
        </div>
      </div>
      ...
      <div className="bg-linear-to-r from-rose-500/6 via-indigo-500/5 to-cyan-500/6 rounded-[10px] p-5 shadow-sm relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 relative z-10">
          <div className="space-y-2">
            ...
            <h2 className="text-base font-extrabold text-slate-850 dark:text-zinc-150 tracking-tight">AI Operations Command Hub</h2>
            <p className="text-xs text-slate-500 dark:text-zinc-400 leading-relaxed max-w-3xl">
              Medi-Doc AI engine is tracking live patient admissions, bed status, and pharmaceutical counts. Currently monitoring 3 predicted anomalies.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 pt-5 border-t border-slate-100 dark:border-zinc-800/80">
          {[
            ...
            <div key={insight.title} className="bg-white/60 dark:bg-zinc-900/60 p-4 rounded-[10px] flex flex-col justify-between gap-3 hover:shadow-md transition-shadow">
              <div className="space-y-1.5">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">AI Forecast</span>
                <h4 className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">{insight.title}</h4>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-normal font-semibold">{insight.desc}</p>
              </div>
              <div className="flex items-center justify-between mt-1">
                <span className={`text-[9px] font-extrabold uppercase tracking-widest px-2.5 py-0.5 rounded-[6px] ${insight.color}`}>
                  {insight.action}
                </span>
                <button className="text-[10px] font-bold text-rose-655 hover:text-rose-700 dark:text-rose-400 hover:underline border-none bg-transparent cursor-pointer">
                  Execute Action
                </button>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white dark:bg-zinc-900 p-4 rounded-[10px] flex flex-col justify-between shadow-sm relative overflow-hidden">
          ...
          <div className="mt-4">
            <div className="text-2xl font-extrabold text-slate-800 dark:text-zinc-150 tracking-tight">28</div>
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-1">New Admissions</div>
            <div className="text-[9px] text-slate-400 mt-0.5">Last 24 hours</div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 p-4 rounded-[10px] flex flex-col justify-between shadow-sm relative overflow-hidden">
          ...
          <div className="mt-4">
            <div className="text-2xl font-extrabold text-slate-800 dark:text-zinc-150 tracking-tight">184/250</div>
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-1">Occupied Beds</div>
            <div className="text-[9px] text-slate-400 mt-0.5">73.6% occupancy</div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 p-4 rounded-[10px] flex flex-col justify-between shadow-sm relative overflow-hidden">
          ...
          <div className="mt-4">
            <div className="text-2xl font-extrabold text-slate-800 dark:text-zinc-150 tracking-tight">12</div>
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-1">Active Emergency</div>
            <div className="text-[9px] text-slate-400 mt-0.5">4 critical cases</div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 p-4 rounded-[10px] flex flex-col justify-between shadow-sm relative overflow-hidden">
          ...
          <div className="mt-4">
            <div className="text-2xl font-extrabold text-slate-800 dark:text-zinc-150 tracking-tight">18 min</div>
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-1">Avg Wait Time</div>
            <div className="text-[9px] text-slate-400 mt-0.5">Target: &lt;20 min</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[10px] p-5 shadow-sm lg:col-span-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-bold text-slate-800 dark:text-zinc-150">Weekly Revenue Trend</h3>
                  <p className="text-[10px] text-slate-400 mt-0.5">Revenue by department (in Million ETB)</p>
                </div>
              ...
              <div className="h-64 mt-6">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={weeklyRevenue} barSize={16}>
                    ...
                    <Bar dataKey="OPD" fill="#3b82f6" radius={[3, 3, 0, 0]} name="OPD Consults" />
                    <Bar dataKey="IPD" fill="#1d4ed8" radius={[3, 3, 0, 0]} name="IPD Services" />
                    <Bar dataKey="Lab" fill="#f59e0b" radius={[3, 3, 0, 0]} name="Laboratory" />
                    <Bar dataKey="Pharmacy" fill="#10b981" radius={[3, 3, 0, 0]} name="Pharmacy" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 border-t border-slate-100 dark:border-zinc-800 pt-4 mt-4 text-center">
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">week total</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">14.8M ETB</span>
              </div>
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">avg/day</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">2.1M ETB</span>
              </div>
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">best day</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">Thu (6.2M)</span>
              </div>
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">growth</span>
                <span className="text-xs font-extrabold text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-0.5 rounded-[6px] inline-block">+12.5%</span>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[10px] p-5 shadow-sm lg:col-span-4 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3.5">
                {[
                  { label: 'OPD Consultations', value: '842,500 ETB', percent: 35, color: 'bg-blue-500', trend: '+0.2%' },
                  { label: 'IPD Services', value: '1,243,800 ETB', percent: 52, color: 'bg-indigo-600', trend: '+12.5%' },
                  { label: 'Laboratory', value: '186,400 ETB', percent: 8, color: 'bg-amber-500', trend: '-2.1%', isDown: true },
                  { label: 'Pharmacy', value: '125,300 ETB', percent: 5, color: 'bg-emerald-500', trend: '-5.8%', isDown: true },
                ].map((item) => (
                  <div key={item.label} className="space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-semibold text-slate-700 dark:text-zinc-300">{item.label}</span>
                      <div className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400">
                        <span className="text-slate-800 dark:text-zinc-200">{item.value}</span>
                        <span className={item.isDown ? 'text-red-500' : 'text-emerald-500'}>{item.trend}</span>
                      </div>
                    </div>
                    <div className="h-1.5 bg-slate-100 dark:bg-zinc-800 rounded-[9px] w-full overflow-hidden">
                      <div className={`h-full rounded-[9px] ${item.color}`} style={{ width: `${item.percent}%` }} />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="border-t border-slate-100 dark:border-zinc-800 pt-4 mt-4">
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-slate-700 dark:text-zinc-300">Monthly Target</span>
                <span className="text-[10px] font-mono text-slate-400">48.2M / 70M ETB</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-2 bg-slate-100 dark:bg-zinc-800 rounded-[9px] flex-1 overflow-hidden">
                  <div className="h-full rounded-[9px] bg-rose-600" style={{ width: '68.5%' }} />
                </div>
                <span className="text-xs font-extrabold text-rose-600 dark:text-rose-400">68.5%</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div>
              ...
              <div className="flex items-center justify-center h-60 relative">
                ...
                <div className="absolute text-center">
                  <span className="text-slate-400 text-[9px] block lowercase font-medium">total patients</span>
                  <span className="text-xl font-extrabold text-slate-800 dark:text-zinc-200">342</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-6 mt-2 text-xs border-b border-slate-100 dark:border-zinc-800 pb-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-slate-500 font-semibold text-[11px]">OPD: <strong className="text-slate-700 dark:text-zinc-200">267</strong></span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-emerald-500" />
                  <span className="text-slate-500 font-semibold text-[11px]">IPD: <strong className="text-slate-700 dark:text-zinc-200">75</strong></span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-center py-2.5 border-b border-slate-100 dark:border-zinc-800 text-xs">
                ...
                <div>
                  ...
                  <span className="font-extrabold text-emerald-600 text-sm">21.9%</span>
                </div>
              </div>

              {/* Department breakdown horizontal list */}
              <div className="space-y-2.5 mt-4">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Department-wise Breakdown</span>
                {[
                  { label: 'General Medicine', value: 90, percent: 90, color: 'bg-rose-500' },
                  { label: 'Pediatrics', value: 70, percent: 70, color: 'bg-blue-500' },
                  { label: 'Surgery', value: 39, percent: 39, color: 'bg-indigo-600' },
                  { label: 'Cardiology', value: 39, percent: 39, color: 'bg-red-500' },
                  { label: 'Orthopedics', value: 37, percent: 37, color: 'bg-amber-500' },
                  { label: 'Others', value: 67, percent: 67, color: 'bg-slate-550' },
                ].map((item) => (
                  <div key={item.label} className="space-y-1">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="font-semibold text-slate-655 dark:text-zinc-400">{item.label}</span>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[10px] p-5 shadow-sm lg:col-span-7 flex flex-col justify-between">
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-zinc-800 text-slate-400 text-[10px] uppercase font-bold tracking-wider">
                      ...
                      <th className="py-2 font-bold text-right">Satisfaction</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      { name: 'Emergency', patients: 142, eff: '92%', sat: '88%' },
                      { name: 'Surgery', patients: 89, eff: '95%', sat: '94%' },
                      { name: 'Pediatrics', patients: 126, eff: '88%', sat: '91%', isDown: true },
                      { name: 'Cardiology', patients: 78, eff: '91%', sat: '89%' },
                    ].map((row) => (
                      <tr key={row.name} className="border-b border-slate-50 dark:border-zinc-800/50 hover:bg-slate-50/50 dark:hover:bg-zinc-800/20 text-slate-700 dark:text-zinc-300 font-medium">
                        ...
                        <td className="py-2.5 text-center flex items-center justify-center gap-1">
                          ...
                          <span className={`text-[9px] ${row.isDown ? 'text-red-500' : 'text-emerald-500'}`}>
                            {row.isDown ? '▼' : '▲'}
                          </span>
                        </td>
                        <td className="py-2.5 text-right font-semibold">{row.sat}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="grid grid-cols-3 gap-2 border-t border-slate-100 dark:border-zinc-800 pt-4 mt-4 text-center text-xs">
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">avg efficiency</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">91.2%</span>
              </div>
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">avg satisfaction</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">89.8%</span>
              </div>
              <div>
                <span className="text-[9px] text-slate-400 block lowercase font-medium">total patients</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-zinc-200">685</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mt-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[10px] p-5 shadow-sm lg:col-span-8">
          <div>
            <h3 className="text-sm font-bold text-slate-800 dark:text-zinc-150">Quick Navigation</h3>
            <p className="text-[10px] text-slate-400 mt-0.5 mb-5">Access key hospital management modules</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              { title: 'Patient Management', desc: 'View, admit, and manage patient records', count: '1,247', icon: Users, link: '/dashboard/admin/users' },
              { title: 'Appointments', desc: 'Schedule and manage appointments', count: '88 today', icon: CalendarDays, link: '/dashboard/admin/appointments' },
              { title: 'Billing & Payments', desc: 'Process payments and generate invoices', count: '2.4M today', icon: DollarSign, link: '/dashboard/admin/payments' },
              { title: 'Bed Management', desc: 'Monitor bed availability and occupancy', count: '184/250 occupied', icon: Bed, link: '/dashboard/admin/bed-management' },
              { title: 'Pharmacy', desc: 'Manage inventory and prescriptions', count: '12 low stock', icon: Pill, link: '/dashboard/admin/pharmacy' },
              { title: 'Laboratory', desc: 'Track tests and manage lab operations', count: '45 pending', icon: FlaskConical, link: '/dashboard/admin/laboratory' },
              { title: 'Medical Records', desc: 'Access electronic health records', icon: FileText, link: '/dashboard/admin/medical-records' },
              { title: 'Emergency Management', desc: 'Emergency department triage control', count: '12 active', icon: Activity, link: '/dashboard/admin/emergency' },
              { title: 'System Settings', desc: 'Configure system and user settings', icon: Settings, link: '/dashboard/admin/settings' },
            ].map((module) => {
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[10px] p-5 shadow-sm lg:col-span-4 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-red-500/5 text-red-700 dark:text-red-400 rounded-[10px] flex gap-3 items-start">
                ...
                <div className="space-y-0.5 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider">ICU Bed Shortage</span>
                    <span className="text-[8px] bg-red-100 dark:bg-red-950 px-1.5 py-0.5 rounded-[6px] shrink-0 font-extrabold">ICU</span>
                  </div>
                  <p className="text-[10px] leading-tight text-red-650/90 dark:text-red-400/80">Only 2 ICU beds available. Consider transfer arrangements.</p>
                  <span className="text-[8px] text-slate-400 block mt-1">🕒 5 min ago</span>
                </div>
              </div>
              ...
              <div className="p-3 bg-amber-500/5 text-amber-700 dark:text-amber-400 rounded-[10px] flex gap-3 items-start">
                ...
                <div className="space-y-0.5 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider">Medicine Stock Low</span>
                    <span className="text-[8px] bg-amber-100 dark:bg-amber-950 px-1.5 py-0.5 rounded-[6px] shrink-0 font-extrabold">Pharmacy</span>
                  </div>
                  <p className="text-[10px] leading-tight text-amber-600/90 dark:text-amber-400/80">Paracetamol 500mg below minimum stock level (120 units).</p>
                  <span className="text-[8px] text-slate-400 block mt-1">🕒 12 min ago</span>
                </div>
              </div>
              ...
              <div className="p-3 bg-amber-500/5 text-amber-700 dark:text-amber-400 rounded-[10px] flex gap-3 items-start">
                ...
                <div className="space-y-0.5 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider">Equipment Maintenance</span>
                    <span className="text-[8px] bg-amber-100 dark:bg-amber-950 px-1.5 py-0.5 rounded-[6px] shrink-0 font-extrabold">Radiology</span>
                  </div>
                  <p className="text-[10px] leading-tight text-amber-600/90 dark:text-amber-400/80">CT Scanner #2 scheduled for maintenance at 3:00 PM.</p>
                  <span className="text-[8px] text-slate-400 block mt-1">🕒 45 min ago</span>
                </div>
              </div>
              ...
              <div className="p-3 bg-slate-500/5 text-slate-750 dark:text-zinc-400 rounded-[10px] flex gap-3 items-start">
                ...
                <div className="space-y-0.5 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider">Staff Meeting</span>
                    <span className="text-[8px] bg-slate-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded-[6px] shrink-0 font-extrabold">General</span>
                  </div>
                  <p className="text-[10px] leading-tight text-slate-655/90 dark:text-zinc-450">Department heads meeting scheduled at 4:30 PM today.</p>
                  <span className="text-[8px] text-slate-400 block mt-1">🕒 1 hour ago</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 gap-2 border-t border-slate-100 dark:border-zinc-800 pt-4 mt-4 text-center text-xs">
            <div className="flex items-center justify-center gap-1.5">
              ...
              <span className="text-slate-550">Critical: <strong className="text-slate-700 dark:text-zinc-200">1</strong></span>
            </div>
            <div className="flex items-center justify-center gap-1.5">
              <span className="h-2 w-2 rounded-full bg-amber-500" />
              <span className="text-slate-550">Warning: <strong className="text-slate-700 dark:text-zinc-200">3</strong></span>
            </div>
          </div>
