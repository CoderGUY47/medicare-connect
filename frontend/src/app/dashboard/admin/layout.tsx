...
export default function AdminDashboardLayout({
  ...
  if (!user || user.role !== 'admin') {
    return (
      <div className="mx-auto max-w-md px-4 py-16 text-center space-y-4">
        ...
        <p className="text-slate-500 dark:text-zinc-400 text-xs">Admin credentials required to access this dashboard.</p>
        <button
  ...
  const sidebarLinks = [
    ...
    { label: 'Patients', href: '/dashboard/admin/users', icon: Users },
    { label: 'Appointments', href: '/dashboard/admin/appointments', icon: CalendarDays },
    { label: 'Bed Management', href: '/dashboard/admin/bed-management', icon: Bed },
    { label: 'Doctors', href: '/dashboard/admin/doctors', icon: ShieldCheck },
    { label: 'Emergency', href: '/dashboard/admin/emergency', icon: Activity },
    { label: 'Laboratory', href: '/dashboard/admin/laboratory', icon: FlaskConical },
    { label: 'Pharmacy', href: '/dashboard/admin/pharmacy', icon: Pill },
    { label: 'Medical Records', href: '/dashboard/admin/medical-records', icon: FileText },
    { label: 'Reports', href: '/dashboard/admin/payments', icon: CreditCard },
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:block text-left leading-none">
                ...
                <span className="text-[9px] text-slate-400 uppercase font-bold tracking-wider">Admin</span>
              </div>
            </div>
