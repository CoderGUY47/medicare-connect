...
export default function PharmacistDashboardLayout({
  ...
  if (!user || user.role !== 'pharmacist') {
    return (
      <div className="mx-auto max-w-md px-4 py-16 text-center space-y-4">
        ...
        <p className="text-slate-500 dark:text-zinc-400 text-xs">Pharmacist credentials required to access this dashboard.</p>
        <button
  ...
  const sidebarLinks = [
    ...
    { label: 'Prescriptions', href: '#', icon: ClipboardList, isPlaceholder: true },
    { label: 'Stock Inventory', href: '#', icon: Pill, isPlaceholder: true },
    { label: 'Dispense History', href: '#', icon: History, isPlaceholder: true },
    { label: 'Stock Warnings', href: '#', icon: AlertTriangle, isPlaceholder: true },
        ...
        <div className="p-5 border-b border-slate-100 dark:border-zinc-800">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 dark:text-zinc-500 font-bold uppercase tracking-wider">Pharmacy Station</p>
            </div>
          </Link>
        </div>
        ...
        <header className="h-16 border-b border-slate-100 dark:border-zinc-900 bg-white dark:bg-zinc-900 flex items-center justify-between px-6 md:px-8 shrink-0 transition-colors">
          ...
          <div className="flex items-center border border-slate-100 dark:border-zinc-800 rounded-xl bg-slate-50/50 dark:bg-zinc-950/20 px-3 py-1.5 w-64 md:w-80 focus-within:bg-white dark:focus-within:bg-zinc-900 focus-within:border-rose-500 focus-within:ring-1 focus-within:ring-rose-500 transition-all">
            ...
            <input 
              ...
              className="bg-transparent text-xs text-slate-900 dark:text-zinc-155 outline-none border-none w-full placeholder:text-slate-400"
            />
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:block text-left leading-none">
                ...
                <span className="text-[9px] text-slate-400 uppercase font-bold tracking-wider">Pharmacist</span>
              </div>
            </div>
