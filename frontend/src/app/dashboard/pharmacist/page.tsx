...
export default function PharmacistOverviewPage() {
  const stats = [
    ...
    {
      label: "Prescriptions Filled Today",
      value: "42",
      icon: CheckCircle,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-zinc-400 mt-0.5">
          e-Prescription filling, stock control, and drug inventory levels
        </p>
      </div>
              ...
              <tbody>
                {prescriptions.map((rx) => (
                  ...
                  >
                    ...
                    <td className="py-3 text-[11px] text-slate-500 font-semibold">
                      {rx.meds}
                    </td>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <h4 className="text-[11px] font-bold text-slate-800 dark:text-zinc-200 truncate">
                        {item.name}
                      </h4>
                    </div>
          ...
          <div className="border-t border-slate-100 dark:border-zinc-800 pt-3 mt-3">
            ...
            <div className="flex items-center gap-1.5 mt-1">
              ...
              <span className="text-xs font-bold text-slate-700 dark:text-zinc-350">
                Delivery Scheduled: Today 2:00 PM
              </span>
            </div>
          </div>
        </div>
